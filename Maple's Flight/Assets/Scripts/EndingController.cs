...
public class EndingController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        titles[4] = "날개가 달린 괴물한테 잡아먹히고 말았어요!";
        titles[5] = "도토리 괴물의 귀여운 모습에 속지 마세요!";
        titles[6] = "호기심 대마왕 토끼는 궁금한걸 참지 못해요!";
        titles[7] = "아기 단풍나무가 되었어요!";
        titles[8] = "어린이 단풍나무가 되었어요!";
        titles[9] = "사춘기 단풍나무가 되었어요!";
        titles[10] = "단풍나무가 만개했어요!";

        desc[0] = "강하게 부는 바람을 타고 올라간 곳엔 끝없는 바다가 펼쳐져 있었어요!";
        desc[1] = "정신없이 떠다니다보니 어느새 나뭇가지에 걸려버렸어요.. 이동 중엔 한 눈 팔지 말기! 명심할게요..";
        desc[2] = "엄마한테 붙어있을 땐 몰랐는데, 나무는 아주 아주 커요. 엄마의 편지처럼 저도 꼭 크고 아름다운 나무가 될 거예요!";
        desc[3] = "결과는 처참했어요.. 다시는 바위를 우습게 보지 않을 거예요.";
        desc[4] = "무시무시한 크기의 날개 달린 괴물을 피하는데 실패하자, 괴물이 날 망설임 없이 집어삼켰어요.";
        desc[5] = "나무 근처를 지나갈 땐 도토리 괴물을 조심해야 해요. 생김새는 귀엽지만 하는 짓은 그렇지 못하거든요.";
        desc[6] = "호기심을 참지 못하고 나무 위로 튀어나온 토끼와 부딪혀 멀리 튕겨나갔어요. 제가 보이지 않을 정도라니..뭐가 그리 궁금한걸까요?";
        desc[7] = "아무래도 비행 시간이 너무 짧았나봐요.. 그래도 이것 보세요! 제가 드디어 뿌리를 틔웠어요!";
